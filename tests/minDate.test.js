...
describe('minDate', function() {
    ...
    it('not date is invalid', function() {
        ...
        expect(validators.minDate([1,2,3], new Date(2000, 0, 1, 0, 0, 5, 0))).to.have.property('error');
    });
    ...
    it('date in GMT format is correct', function() {
        expect(validators.minDate('Sat Jan 04 2000 23:59:59 GMT+0300 (MSK)', 'Sat Jan 05 2000 GMT+0300 (MSK)')).to.have.property('error');
        expect(validators.minDate('Sat Jan 06 2000 23:59:59 GMT+0300 (MSK)', 'Sat Jan 05 2000 GMT+0300 (MSK)')).to.be.undefined;
    });

    it('date in ISO format is correct', function() {
        expect(validators.minDate('2000-01-04T23:59:59.000Z', '2000-01-06Z')).to.have.property('error'); //+UTC
